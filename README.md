...
## Installation
    ...
    ./bin/plugin -install bundle -url http://xbib.org/repository/org/xbib/elasticsearch/plugin/elasticsearch-plugin-bundle/1.5.2.2/elasticsearch-plugin-bundle-1.5.2.2-plugin.zip
