...
### Elasticsearch 2.x
    ...
    ./bin/plugin install 'http://search.maven.org/remotecontent?filepath=org/xbib/elasticsearch/plugin/elasticsearch-plugin-bundle/2.2.0.6/elasticsearch-plugin-bundle-2.2.0.6-plugin.zip'
