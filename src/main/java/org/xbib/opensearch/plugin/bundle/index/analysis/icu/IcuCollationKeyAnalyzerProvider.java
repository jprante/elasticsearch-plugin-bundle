    ...
    public static Collator createCollator(Settings settings) {
        ...
        if (rules != null) {
            try {
                ...
                throw new OpenSearchException("Failed to parse collation rules", e);
            }
        } else {
        ...
        if (strength != null) {
            ...
            switch (strength.toLowerCase(Locale.ROOT)) {
                ...
                case "identical":
                    ...
                    break;
                default:
                    throw new OpenSearchException("Invalid strength: " + strength);
            }
        ...
        if (decomposition != null) {
            if ("no".equalsIgnoreCase(decomposition)) {
                ...
                throw new OpenSearchException("Invalid decomposition: " + decomposition);
            }
        }
        ...
        if (alternate != null) {
            if ("shifted".equalsIgnoreCase(alternate)) {
                ...
                throw new OpenSearchException("Invalid alternate: " + alternate);
            }
        }
        ...
        if (caseFirst != null) {
            if ("lower".equalsIgnoreCase(caseFirst)) {
                ...
                throw new OpenSearchException("invalid caseFirst: " + caseFirst);
            }
        }
                ...
                switch (s.toLowerCase(Locale.ROOT)) {
                    ...
                    default:
                        ...
                        if (code == UScript.INVALID_CODE) {
                            throw new OpenSearchException("invalid reorder code: " + s);
                        } else {
                            list.add(code);
                        }
                }
