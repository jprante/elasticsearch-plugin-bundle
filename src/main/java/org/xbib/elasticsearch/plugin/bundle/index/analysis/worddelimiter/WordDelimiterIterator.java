...
import static org.xbib.elasticsearch.plugin.bundle.index.analysis.worddelimiter.WordDelimiterFilter.ALPHA;
import static org.xbib.elasticsearch.plugin.bundle.index.analysis.worddelimiter.WordDelimiterFilter.DIGIT;
import static org.xbib.elasticsearch.plugin.bundle.index.analysis.worddelimiter.WordDelimiterFilter.LOWER;
import static org.xbib.elasticsearch.plugin.bundle.index.analysis.worddelimiter.WordDelimiterFilter.SUBWORD_DELIM;
import static org.xbib.elasticsearch.plugin.bundle.index.analysis.worddelimiter.WordDelimiterFilter.UPPER;
import static org.xbib.elasticsearch.plugin.bundle.index.analysis.worddelimiter.WordDelimiterFilter.isAlpha;
import static org.xbib.elasticsearch.plugin.bundle.index.analysis.worddelimiter.WordDelimiterFilter.isDigit;
import static org.xbib.elasticsearch.plugin.bundle.index.analysis.worddelimiter.WordDelimiterFilter.isSubwordDelim;
import static org.xbib.elasticsearch.plugin.bundle.index.analysis.worddelimiter.WordDelimiterFilter.isUpper;
