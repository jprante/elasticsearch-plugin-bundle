 ...
 *
 */
public class FstExpansionTokenFilter extends TokenFilter {
    ...
    protected FstExpansionTokenFilter(TokenStream input, Dictionary dictionary, boolean respectKeywords) {
        super(input);
    ...
    private void expand() throws CharacterCodingException {
    ...
    public boolean equals(Object object) {
        return object instanceof FstExpansionTokenFilter &&
                tokens.equals(((FstExpansionTokenFilter)object).tokens) &&
                dictionary.equals(((FstExpansionTokenFilter)object).dictionary) &&
                respectKeywords == ((FstExpansionTokenFilter)object).respectKeywords;
    }
