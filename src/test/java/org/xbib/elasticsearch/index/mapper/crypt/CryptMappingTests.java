...
public class CryptMappingTests extends Assert {
    ...
    public void testSHA256CryptMapping() throws Exception {
        ...
        DocumentMapper docMapper = docMapperParser.parse("someType", new CompressedXContent(mapping));
        ...
        docMapper = docMapperParser.parse("someType", new CompressedXContent(builtMapping));
