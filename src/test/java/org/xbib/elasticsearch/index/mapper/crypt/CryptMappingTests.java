...
public class CryptMappingTests extends Assert {
    ...
    public void testSHA256CryptMapping() throws Exception {
        ...
        DocumentMapper docMapper = MapperTestUtils.newDocumentMapperParser("test").parse("someType", new CompressedXContent(mapping));
        ...
        docMapper = MapperTestUtils.newDocumentMapperParser("test").parse("someType", new CompressedXContent(builtMapping));
